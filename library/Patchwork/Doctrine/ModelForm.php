 ...
 * @subpackage Doctrine
 */
class Patchwork_Doctrine_ModelForm
    extends Zend_Form
{
    /**
            ...
            switch($relation->getType()) {
                ...
                case Doctrine_Relation::MANY:
                    ...
                    foreach($this->_instance->$name as $num => $rec) {
                        ...
                        $form->addElement(
                            'submit',
                            $this->_getDeleteButtonName($name, $rec), array(
                            'label' => 'Delete'
                        ));
    ...
    /**
     * returns the associated instance or a new instance
     *
    ...
    public function isValid($data) {
        ...
        foreach($this->_getRelations() as $name => $relation) {
            ...
            if(isset($ndata[$this->_getNewButtonName($name)])
                ...
                $form->addElement(
                    'submit',
                    $this->_getDeleteButtonName($name),
                    array('label' => 'Delete')
                );
